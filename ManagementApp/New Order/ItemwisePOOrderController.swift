//
//  ItemwisePOOrderController.swift
//  ManagementApp
//
...
class ItemwisePOOrderController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, PopupDateDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        branchwiseApiUrl = "https://test2.goldmedalindia.in/api/getitempowisependingamount"
        apiGetBranchwiseOrders()
        ViewControllerUtils.sharedInstance.showLoader()
        if poType == "0"{
            self.title = "Transfer Pending PO "
        }else{
            self.title = "Sales Pending PO "
        }
        lblHeader.text = "\(itemName)"
        //Sort
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            ...
            case 6:
                cell.contentLabel.text = filterOrdersObj[indexPath.section - 1].ponum
            default:
                break
            }
...
//        else if indexPath.section != 0 && indexPath.section != vendorListData.count + 1{
...
//            destViewController.itemid = filterOrdersObj[indexPath.section-1].itemslno!
...
//        }
    ...
    func apiGetBranchwiseOrders(){
        ...
        let json: [String: Any] = ["CIN":UserDefaults.standard.value(forKey: "userCIN") as! String,"Category":UserDefaults.standard.value(forKey: "userCategory") as! String,"ClientSecret":"ClientSecret", "BranchId":branchId,"potype":poType,"Catid":catId,"ItemId":itemId]
