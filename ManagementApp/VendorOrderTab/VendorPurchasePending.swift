...
import UIKit
import Charts
@IBDesignable class VendorPurchasePending: BaseCustomView {
    ...
    @IBOutlet weak var collectionView: VendorOrderPurPenCollectionView!
    ...
    func apiLastDispatchedMaterial(){
            ...
            let json: [String: Any] =  ["CIN":UserDefaults.standard.value(forKey: "userCIN") as! String, "Category":UserDefaults.standard.value(forKey: "userCategory") as! String, "Date":getIdiotsDateFormat(value: strToDate),"cnt":"5","vendorid":appDelegate.sendCin,"ClientSecret":"ohdashfl"]
...
extension VendorPurchasePending: UICollectionViewDataSource {
...
extension VendorPurchasePending: UICollectionViewDelegate {
    
}



class VendorOrderPurPenCollectionView: UICollectionView {
