...
import Foundation
import UIKit
@IBDesignable class VendorPurchaseItemwisse: BaseCustomView {
...
extension VendorPurchaseItemwisse: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                ...
                cell.contentLabel.text = "Basic Amt"
        ...
        if indexPath.section != 0 {
            if(self.vendorListData.count > 0)
            {
                if indexPath.row == 0 {
                    ...
                    cell.contentLabel.text = "    \(self.vendorListData[indexPath.section-1].invoiceDate ?? "")"
                } else if indexPath.row == 1 {
                    ...
                    cell.contentLabel.text = self.vendorListData[indexPath.section-1].quantity ?? "-"
                } else if indexPath.row == 4 {
...
extension VendorPurchaseItemwisse: UICollectionViewDelegate {
