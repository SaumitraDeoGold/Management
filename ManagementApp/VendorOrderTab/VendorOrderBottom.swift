//
//  VendorOrderBottom.swift
//  ManagementApp
//
//  Created by Goldmedal on 17/07/20.
//  Copyright © 2020 Goldmedal. All rights reserved.
//
struct VendorOrderBottomData: Codable {
    let result: Bool?
    let message, servertime: String?
    let data: [VendorOrderBottomObj]
}
...
import Foundation
import UIKit
@IBDesignable class VendorOrderBottom: BaseCustomView {
    ...
    @IBOutlet weak var collectionView: VendorBottomCollectionView!
    ...
    func apiLastDispatchedMaterial(){
        ...
        let json: [String: Any] =  ["vendorid":appDelegate.sendCin,"CIN":UserDefaults.standard.value(forKey: "userCIN") as! String, "Category":UserDefaults.standard.value(forKey: "userCategory") as! String,"index":"0","cnt":"5","ClientSecret":"ohdashfl","FromDate":"06-27-2018","ToDate":"06-27-2020"]
        print("Vendor Purchase Item Params \(json)")
        DataManager.shared.makeAPICall(url: vendorListApi, params: json, method: .POST, success: { (response) in
            let data = response as? Data
                ...
                do {
                    ...
                    print("Vendor Purchase Item Data \(self.vendorListData)")
...
extension VendorOrderBottom: UICollectionViewDataSource {
...
extension VendorOrderBottom: UICollectionViewDelegate {
    
}



class VendorBottomCollectionView: UICollectionView {
