...
class EmployeeDetailsController: BaseViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        addSlideMenuButton()
        apiEmployeeDetails = "https://test2.goldmedalindia.in/api/getEmployeeList"
        apiEmployeeLocn = "https://test2.goldmedalindia.in/api/getlocationEmployeeList"
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            ...
            case 0:
                cell.contentLabel.text = showLoc ? "Location Name" : "Branch Name"
            case 1:
                cell.contentLabel.text = "Employee Count"
            case 2:
                cell.contentLabel.text = "Executive Count"
            case 3:
                cell.contentLabel.text = "Int.Employee Count"
            default:
                break
            }
            ...
            switch indexPath.row{
            case 0:
                cell.contentLabel.text = showLoc ? filteredLoc[indexPath.section-1].locationName :filteredItems[indexPath.section-1].branchName
            case 1:
                cell.contentLabel.text = showLoc ? String(filteredLoc[indexPath.section-1].employeeCount!) :String(filteredItems[indexPath.section-1].employeeCount!)
            case 2:
                cell.contentLabel.text = showLoc ? String(filteredLoc[indexPath.section-1].execCount!) :String(filteredItems[indexPath.section-1].execCount!)
            case 3:
                cell.contentLabel.text = showLoc ? String(filteredLoc[indexPath.section-1].internalEmpCount!) :String(filteredItems[indexPath.section-1].internalEmpCount!)
            default:
                break
            }
