//
//  SupplierDashboardController.swift
//  ManagementApp
//
...
class SupplierDashboardController: BaseViewController {
...
extension SupplierDashboardController: ViewPagerControllerDataSource {
    ...
    func viewControllerAtPosition(position:Int) -> UIViewController {
        ...
        {
            vc = self.storyboard?.instantiateViewController(withIdentifier: "SupplierInvoicesController") as! SupplierInvoicesController
        }
        return vc
    }
...
extension SupplierDashboardController: ViewPagerControllerDelegate {
