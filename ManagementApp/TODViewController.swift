...
struct TODSubmitElement: Codable {
    let result: Bool?
    let message, servertime: String?
    let data: TODSubmitObj
}

struct TODSubmitObj: Codable {
}

class TODViewController: BaseViewController {
...
//        strApiSubmitTOD = "https://test2.goldmedalindia.in/api/submitGroupTOD"
        ...
        Analytics.setScreenName("TOD SCREEN", screenClass: "TODViewController")
    ...
    func apiTOD(){
        ...
        let json: [String: Any] =
            ["CIN":cinReceived,"ClientSecret":"ClientSecret"]
...
extension TODViewController: ViewPagerControllerDataSource {
...
extension TODViewController: ViewPagerControllerDelegate {
