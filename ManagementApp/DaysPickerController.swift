...
class DaysPickerController: UIViewController ,UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    @IBAction func ok_clicked(_ sender: UIButton) {
        ...
        delegate?.updateOutsDaysValue!(value: strSelectedValue, position: rowPosition)
        dismiss(animated: true)
    }
    ...
    override func viewDidLoad() {
        ...
        if showPicker == 1 {
            //print("--------Q----------",showPicker)
            pickerDataSource = ["150 Days", "180 Days", "210 Days", "270 Days"];
