...
open class SideMenuTransition: UIPercentDrivenInteractiveTransition {
   ...
   @objc internal class func handlePresentMenuRightScreenEdge(_ edge: UIScreenEdgePanGestureRecognizer) {
    ...
    internal class func presentMenuComplete() {
        NotificationCenter.default.addObserver(SideMenuTransition.singleton, selector:#selector(SideMenuTransition.applicationDidEnterBackgroundNotification), name: NSNotification.Name.UIApplicationWillResignActive, object: nil)
